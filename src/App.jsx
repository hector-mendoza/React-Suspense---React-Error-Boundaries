  ...
  const content = currentUserId === 0
    ...
    : (
      <ErrorBoundary FallbackComponent={ErrorFallback}
        ...
        {/* onReset => if error, set the state to a initial state value */}
        {/* resetKeys => if  state changes reset errors/don't show any error */}
        <Suspense fallback={[...Array(10).keys()].map(i =>
          <SkeletonPost key={i} />
        )}>
